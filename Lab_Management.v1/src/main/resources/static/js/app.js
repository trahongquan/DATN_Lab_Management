...
function switchTheme(e) {
    if (e.target.checked) {
        document.documentElement.setAttribute('data-theme', 'darkAdmin');
        localStorage.setItem('theme', 'darkAdmin');
    } else {
        document.documentElement.setAttribute('data-theme', 'lightAdmin');
        localStorage.setItem('theme', 'lightAdmin');
    }
}
