...
public class Booking implements Serializable {
    ...
    public String getConfirmUsed() {
        return confirmUsed;
    }

    public void setConfirmUsed(String comfirmUsed) {
        this.confirmUsed = comfirmUsed;
    }
}
